...
activities = {
    ...
    "Volleyball Club": {
        "description": "Learn volleyball techniques and participate in tournaments",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu"]
    },
    "Music Band": {
        "description": "Learn various instruments and perform in school concerts",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Theater Club": {
        "description": "Perform in theatrical productions and drama classes",
